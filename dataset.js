const dataset = [
    {
        //todos os outros itens vai ter a mesma estrutura
      id: 1, //identificador do item
      name: 'Hambúrguer', // nessa aplicação vai declarar o nome do item q vai pro card no html pelo codigo cardapio.js
      image: 'images/hamburguer.jpg', //imagem no card 
      description: //descrição que vai aparecer no card
